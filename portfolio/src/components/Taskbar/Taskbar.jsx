        ...
        <div className="taskbar">
            ...
            <div className="taskbar-system-tray">
                <div className={`tray-social-links ${isTrayExpanded ? 'expanded' : 'collapsed'}`}>
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/chase-bezilla-3325bb295/" target="_blank" rel="noreferrer" className="tray-social-icon">
                    ...
                    {/* GitHub */}
                    <a href="https://github.com/xezixa" target="_blank" rel="noreferrer" className="tray-social-icon">
                        <svg viewBox="0 0 24 24">
                    ...
                    {/* Instagram */}
                    <a href="https://www.instagram.com/bezilla/" target="_blank" rel="noreferrer" className="tray-social-icon">
                        <svg viewBox="0 0 24 24">
                            <defs>
